...
\label{sec:org8127185}
Block Ciphers divide the message \(M\) into blocks and encrypt each one with \emph{K}. The encryption algorithm itself is deterministic. \cite{noauthor_block_2019,weaver_symmetric_nodate} 
\begin{enumerate}
\item \textbf{Electronic Code Book}
\label{sec:org80a3783}
