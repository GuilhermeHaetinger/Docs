...
\name{Guilherme Gomes Haetinger} % Your name
%\address{156 Kasturi, Balajinagar, Sangli 416416} % Your address
%\address{123 Pleasant Lane \\ City, State 12345} % Your secondary addess (optional)
\address{ghaetinger@gmail.com} % Your phone number and email
...
{\bf Colégio Anchieta} \hfill {\em 2013 - 2015} 
\\ High School \hfill {\bf CGPA - 9.0}
\\
\\{\bf Universidade Federal do Rio Grande do Sul} \hfill {\em 2016 - ongoing} 
\\ Bachelor of Computer Science \hfill { \bf GPA - 3.65 }
